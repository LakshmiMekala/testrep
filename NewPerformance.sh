...
#         done
 mashling create -f $GOPATH/src/github.com/TIBCOSoftware/mashling-recipes/KafkaTrigger-To-KafkaPublisher/KafkaTrigger-To-KafkaPublisher.json KafkaTrigger-To-KafkaPublisher
